...
def train(
    ...
    gen_train = training_dataset.DatasetTF(
                direc=train_path,
    ...
    gen_test = training_dataset.DatasetTF(
                direc=test_path,
                batch_size=batch_size,
                augmentation=False)
    ...
    cnn_model = resunet.ResUNet(input_shape=input_shape, classes=gen_train.classes)
    model = cnn_model.architecture()
